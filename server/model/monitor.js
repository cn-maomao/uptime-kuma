...
class Monitor extends BeanModel {
    ...
    toJSON(preloadData = {}, includeSensitiveData = true) {
        ...
        let data = {
            ...
            hllMinPlayersEnabled: Boolean(this.hllMinPlayersEnabled),
            hllMinPlayers: this.hllMinPlayers,
            hllExitEnabled: Boolean(this.hllExitEnabled),
            hllExitDrop: this.hllExitDrop,
            hllExitWindowSec: this.hllExitWindowSec,
        ...
        if (includeSensitiveData) {
            data = {
                ...
                hllRconPassword: this.hllRconPassword,
