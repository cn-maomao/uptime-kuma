                ...
                <div class="shadow-box shadow-box-with-fixed-bottom-bar">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="my-3">
                                ...
                                >
                                    ...
                                    <optgroup :label="$t('monitorTypeGameServer')">
                                        ...
                                        <option value="hll-rcon">
                                            {{ $t("Hell Let Loose RCON") }}
                                        </option>
                                        <option value="steam">
                                            {{ $t("Steam Game Server") }}
                                        </option>
                            ...
                            <template v-if="monitor.type === 'hll-rcon'">
                                <div class="my-3">
                                    <label for="hll-rcon-password" class="form-label">{{ $t("RCON Password") }}</label>
                                    <HiddenInput
                                        id="hll-rcon-password"
                                        v-model="monitor.hllRconPassword"
                                        autocomplete="false"
                                        required="true"
                                    ></HiddenInput>
                                    <div class="form-text">
                                        {{ $t("hllRconPasswordDescription") }}
                                    </div>
                                </div>

                                <div class="my-3 form-check">
                                    <input
                                        id="hll-min-players-enabled"
                                        v-model="monitor.hllMinPlayersEnabled"
                                        class="form-check-input"
                                        type="checkbox"
                                    />
                                    <label class="form-check-label" for="hll-min-players-enabled">
                                        {{ $t("hllMinPlayersEnabled") }}
                                    </label>
                                    <div class="form-text">
                                        {{ $t("hllMinPlayersDescription") }}
                                    </div>
                                </div>

                                <div v-if="monitor.hllMinPlayersEnabled" class="my-3">
                                    <label for="hll-min-players" class="form-label">{{ $t("hllMinPlayers") }}</label>
                                    <input
                                        id="hll-min-players"
                                        v-model.number="monitor.hllMinPlayers"
                                        type="number"
                                        class="form-control"
                                        min="0"
                                        max="200"
                                ...
                                <div class="my-3 form-check">
                                    <input
                                        id="hll-exit-enabled"
                                        v-model="monitor.hllExitEnabled"
                                        class="form-check-input"
                                        type="checkbox"
                                    />
                                    <label class="form-check-label" for="hll-exit-enabled">
                                        {{ $t("hllExitEnabled") }}
                                    </label>
                                    <div class="form-text">
                                        {{ $t("hllExitDescription") }}
                                    </div>
                                </div>

                                <div v-if="monitor.hllExitEnabled" class="my-3">
                                    <label for="hll-exit-drop" class="form-label">{{ $t("hllExitDrop") }}</label>
                                    <input
                                        id="hll-exit-drop"
                                        v-model.number="monitor.hllExitDrop"
                                        type="number"
                                        class="form-control"
                                        min="1"
                                        max="200"
                                ...
                                <div v-if="monitor.hllExitEnabled" class="my-3">
                                    <label for="hll-exit-window" class="form-label">{{ $t("hllExitWindowSec") }}</label>
                                    <input
                                        id="hll-exit-window"
                                        v-model.number="monitor.hllExitWindowSec"
                                        type="number"
                                        class="form-control"
                                        min="30"
                                        max="86400"
...
const monitorDefaults = {
    ...
    hllRconPassword: "",
    hllMinPlayersEnabled: false,
    hllMinPlayers: 5,
    hllExitEnabled: false,
    hllExitDrop: 10,
    hllExitWindowSec: 300,
    remote_browser: null,
    screenshot_delay: 0,
    rabbitmqNodes: [],
    rabbitmqUsername: "",
